...
public class AndroidElement extends MobileElement<AndroidElement>
        implements FindsByAndroidUIAutomator<AndroidElement>, FindsByAndroidDataMatcher<AndroidElement>,
        FindsByAndroidViewTag<AndroidElement> {
    /**
